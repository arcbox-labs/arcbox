...
pub mod network_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/arcbox.api.NetworkService/CreateNetwork",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("arcbox.api.NetworkService", "CreateNetwork"));
            self.inner.unary(req, path, codec).await
        }
        /// Removes a network.
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/arcbox.api.NetworkService/RemoveNetwork",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("arcbox.api.NetworkService", "RemoveNetwork"));
            self.inner.unary(req, path, codec).await
        }
        /// Lists networks.
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/arcbox.api.NetworkService/ListNetworks",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("arcbox.api.NetworkService", "ListNetworks"));
            self.inner.unary(req, path, codec).await
        }
        /// Inspects a network.
        pub async fn inspect_network(
            &mut self,
            request: impl tonic::IntoRequest<super::InspectNetworkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InspectNetworkResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/arcbox.api.NetworkService/InspectNetwork",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("arcbox.api.NetworkService", "InspectNetwork"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod network_service_server {
    ...
    pub trait NetworkService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn inspect_network(
            &self,
            request: tonic::Request<super::InspectNetworkRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InspectNetworkResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/arcbox.api.NetworkService/RemoveNetwork" => {
                    #[allow(non_camel_case_types)]
                    struct RemoveNetworkSvc<T: NetworkService>(pub Arc<T>);
                    impl<
                        T: NetworkService,
                    ...
                    for RemoveNetworkSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NetworkService>::remove_network(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/arcbox.api.NetworkService/InspectNetwork" => {
                    #[allow(non_camel_case_types)]
                    struct InspectNetworkSvc<T: NetworkService>(pub Arc<T>);
                    impl<
                        T: NetworkService,
                    > tonic::server::UnaryService<super::InspectNetworkRequest>
                    for InspectNetworkSvc<T> {
                        type Response = super::InspectNetworkResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NetworkService>::inspect_network(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InspectNetworkSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "arcbox.api.NetworkService";
