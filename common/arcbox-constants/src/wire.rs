...
impl MessageType {
    ...
    pub const fn from_u32(value: u32) -> Option<Self> {
        match value {
            ...
            0x0006 => Some(Self::EnsureK3sRequest),
            ...
            0x1006 => Some(Self::EnsureK3sResponse),
...
mod tests {
    ...
    fn message_type_roundtrip_known_values() {
        const CASES: &[(u32, MessageType)] = &[
            ...
            (0x0006, MessageType::EnsureK3sRequest),
            ...
            (0x1006, MessageType::EnsureK3sResponse),
