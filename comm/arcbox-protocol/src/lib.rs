...
pub mod agent {
    pub use super::v1::{
        AgentPingRequest, AgentPingResponse, K3sEnsureRequest, K3sEnsureResponse, NfsEnsureRequest,
        NfsEnsureResponse, PortBindingsChanged, PortBindingsRemoved, RuntimeEnsureRequest,
