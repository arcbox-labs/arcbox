...
pub async fn proxy(state: &AppState, uri: &Uri, req: Request<Body>) -> Result<Response> {
...
pub async fn proxy_upload(state: &AppState, uri: &Uri, req: Request<Body>) -> Result<Response> {
...
pub async fn proxy_upgrade_to_role(
    state: &AppState,
    role: UtilityVmRole,
    uri: &Uri,
    req: Request<Body>,
