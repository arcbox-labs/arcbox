...
function optionalDate(ts: Parameters<typeof timestampDate>[0] | undefined): Date | undefined {
...
export function sandboxSummaryFromProto(summary: SandboxSummaryProto): SandboxSummary {
